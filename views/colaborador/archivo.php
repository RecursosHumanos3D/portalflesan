...
>>>>>>> 9a7dc542a1b16654dd704bc5cdfa34d4bd6f407d
        ...
        <?php } ?>
<<<<<<< HEAD
        <p><?php echo $post['rdescArchivo']; ?></p>
        <a target="_blank" href="../web/img/archivos/<?php echo $post['rdescripcionPost']; ?>"> Descargar archivo <?php echo $post['rnombreArchivo']; ?></a></p>
