...
<div class="box box-widget">
                    <div class="box-header with-border">
                      <div class="user-block">
                        ...
                        <span class="description">Compartido el - 7:30 PM Today</span>
                      </div>
                    </div>
                    <div class="box-body">
                      <p> <video id="video2" controls preload="auto">
...
<<<<<<< HEAD
                    ...
                    <a onclick="compartir(<?php echo $post["ridPost"]; ?>,<?php echo $rutColaborador; ?>)" title="Compartir"> <i class="fas fa-share-square"></i></a>
                    <?php if ($post["rutColaborador1"] == $rutColaborador) { ?>
                        ...
                        <?php } ?>
                      <span class="pull-right text-muted"><?php echo $modelac[0]["cuenta"]; ?> Me gusta - <?php echo $modela[0]["cuenta"]; ?> Comentarios</span>
                    </div>
